...
<a href="/home">Home</a> > <a href="/kelas">Kelas</a>
<div class="card">
...
<script>
    ...
    $(document).ready( function () {
                        ...
                        "columns": [
...

                            {
                                ...
                                render: function(data) {
                                    return'<a href="{{ url('/kelas/detail') }}/'+data+'" data-id="'+data+'" id="detail" class="text-success" title="detail"><i class="anticon anticon-eye"></i> </a> &nbsp;'+
        ...
        $(document).on('click', '#edit', function() {
                ...
                $('#semester').val(data.semester).change();
