                ...
                <div class="modal-body">
                    <form id="form">
                        ...
                        <div class="form-group" id="div_masuk">
                            ...
                            <input required type="time" class="form-control" id="masuk_input" name="masuk_input" placeholder="...." >
                        </div>
                        <div class="form-group" id="div_keluar">
                            <label>Jam Keluar</label>
                            <input required type="time" class="form-control" id="keluar_input" name="keluar_input" placeholder="...." >
                        </div>
                        <div class="form-group" id="div_durasi">
                            <label>Durasi</label>
                            <input required type="time" class="form-control" id="durasi_input" name="durasi_input" placeholder="...." >
                        </div>
...
<script>
    ...
    $(document).ready( function () {
        ...
        function loadData() {
            $('#table').dataTable({
                 "ajax": "{{ url('/absensi/data') }}",
                        "columns": [
                            { "data": "krs.kelas.kode_kelas" },
